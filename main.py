...
class Pawn(Piece):
    def __init__(self, turtle, piece, team, posX, posY):
        super().__init__(turtle, "pawn", team, posX, posY)
    def getPos(self):
        super().getPos()
    def getX(self):
        super().getX()
...
class Bishop(Piece):
    ...
    def __init__(self, turtle, piece, team, posX, posY):
        super().__init__(turtle, "bishop", team, posX, posY)
    def getPos(self):
        super().getPos()
    def getX(self):
        super().getX()
    ...
    def showLegalMoves(self):
        ...
        for i in range(8):
            self.turtle.goto(self.getX()+100, self.getY()+self+100)
            if self.isMoveLegal():
                self.stampMove()
...
class Knight(Piece):
    ...
    def __init__(self, turtle, piece, team, posX, posY):
        super().__init__(turtle, "knight", team, posX, posY)
    def getPos(self):
        super().getPos()
    def getX(self):
        super().getX()
...
class Rook(Piece):
    ...
    def __init__(self, turtle, piece, team, posX, posY):
        super().__init__(turtle, "rook", team, posX, posY)
    def getPos(self):
        super().getPos()
    def getX(self):
        super().getX()
...
class Queen(Piece):
    ...
    def __init__(self, turtle, piece, team, posX, posY):
        super().__init__(turtle, "queen", team, posX, posY)
    def getPos(self):
        super().getPos()
    def getX(self):
        super().getX()
...
class King(Piece):
    def __init__(self, turtle, piece, team, posX, posY):
        super().__init__(turtle, "king", team, posX, posY)
        self.Check = False
    def getPos(self):
        super().getPos()
    def getX(self):
